...
const footerLinks = [
  {
    heading: "Guides",
    links: [
      { label: "Free Cute Kit 🎀", href: "/cute-kit" },
      { label: "What Is Coquette?", href: "/guides/what-is-the-coquette-aesthetic" },
      { label: "Do Cases Turn Yellow?", href: "/guides/do-clear-phone-cases-turn-yellow" },
    ],
  },
  {
    heading: "Quick Links",
...
// Only real, owned profiles belong here. These URLs must match the `sameAs`
// list in app/layout.tsx — if the footer and the schema disagree about which
// accounts are ours, we're telling Google two different stories.
const socialLinks = [
  {
    label: "TikTok",
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/casekisses.shop/",
    icon: (
      <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" aria-hidden="true">
  ...
  // ⚠️ REMOVED: the Facebook link pointed at facebook.com/casekisses, which was
  // never confirmed as ours. Linking to an account we don't own hands our
  // traffic to a stranger. Add it back only when the real URL is known.
]
